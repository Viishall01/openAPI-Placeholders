...
export class TodoController {
  ...
  addTodo(title: string, priority: 'High' | 'Medium' | 'Low' = "Medium", date = new Date().toISOString().split("T")[0]) : Todo{
    const newTodo: Todo = {
  ...
  updateTodoById (id: number, updatedFeilds: Partial<Todo>): Todo | null {
